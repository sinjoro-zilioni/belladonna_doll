...
from functions.key_sys import ag_key_holder, au_key_holder
...
async def group_list(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
...
group_list_command = CommandHandler("groups", group_list)
